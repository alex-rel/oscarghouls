...
public class Renderer {
	...
	private void drawButtons(){
		...
		batch.draw(action, stage.getAction2().getPosition().x * ppuX , stage.getAction2().getPosition().y * ppuY , stage.getAction2().getWidth() * ppuX, stage.getAction2().getHeight() * ppuY);
	}
